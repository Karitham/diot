...
import Checkbi from '../../public/checkbi.svg'
import Clap from '../../public/clap.svg'
import Spinner from '../../public/spinner.svg'
import Skull from '../../public/skull.svg'


const device1 = { src: Clap, name: 'Living Room Cam 1' }
const device2 = { src: Spinner, name: 'Living Room Cam 2' }
const device3 = { src: Checkbi, name: 'Bedroom Fire Captor' }
const device4 = { src: Skull, name: 'Bedroom Cam' }
